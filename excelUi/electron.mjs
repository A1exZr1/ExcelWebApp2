...
// ⬇️ Укажем абсолютный путь к .exe
const backendPath = path.resolve(__dirname, '../ExcelWebApp2/bin/Release/net8.0/win-x64/publish')
...
async function createWindow() {
  ...
  // ⬇️ Запускаем backend из реальной папки
